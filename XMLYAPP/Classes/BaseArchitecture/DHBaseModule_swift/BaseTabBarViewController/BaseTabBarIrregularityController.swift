//
//  BaseTabBarIrregularityController.swift
//  Pods
//
...
class BaseTabBarIrregularityController: BaseTabBarBouncesContentView {
...
class TabBarIrregularityController: ESTabBarItemContentView {
    override init(frame: CGRect) {
        super.init(frame: frame)
